...
class DashboardBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build(): array {
    ...
    $data = [
      ...
      'loans-overdue-text' => $this->t("Returned too late", [], $context),
      'loans-soon-overdue-text' => $this->t("To be returned soon", [], $context),
      ...
      'remove-all-reservations-text' => $this->t("Remove reservations", [], $context),
      'choose-all-text' => $this->t("Select all", [], $context),
      'physical-text' => $this->t("Physical", [], $context),
      'group-modal-return-library-text' => $this->t("Can be returned to all branches of (library) libraries", [], $context),
