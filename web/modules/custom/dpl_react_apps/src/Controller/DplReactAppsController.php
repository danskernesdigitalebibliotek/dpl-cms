...
class DplReactAppsController extends ControllerBase {
  ...
  public function search(): array {
    ...
    $data = [
      ...
      'facet-fictional-characters-text' => $this->t('Fictional characters', [], $options),
  ...
  public function work(string $wid): array {
    ...
    $data = [
      ...
      'changeInterestPeriodText' => $this->t('Change interest period', [], $c),
      'change-pickup-location-text' => $this->t('Change pickup location', [], $c),
      'change-sms-number-text' => $this->t('Change SMS number', [], $c),
      'change-email-text' => $this->t('Change email', [], $c),
      ...
      'film-adaptations-text' => $this->t('Film adaptations', [], $c),
      ...
      'firstAvailableEditionText' => $this->t('First available edition', [], $c),
