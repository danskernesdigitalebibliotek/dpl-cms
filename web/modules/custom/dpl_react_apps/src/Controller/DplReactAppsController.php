...
class DplReactAppsController extends ControllerBase {
  ...
  public function work(string $wid): array {
    $data = [
      ...
      'online-internal-modal-close-modal-aria-label-text' => $this->t('Close reader/player modal', [], ['context' => 'Work Page']),
      'online-internal-modal-screen-reader-modal-description-text' => $this->t('Modal for reader/player material', [], ['context' => 'Work Page']),
      'online-internal-response-title-text' => $this->t('Online material loan/reservation response"', [], ['context' => 'Work Page']),
      'online-internal-errors-text' => $this->t('Something went wrong', [], ['context' => 'Work Page']),
      'online-internal-success-loaned-text' => $this->t('E-material is loaned', [], ['context' => 'Work Page']),
      'online-internal-success-reserved-text' => $this->t('E-material is reserved', [], ['context' => 'Work Page']),
