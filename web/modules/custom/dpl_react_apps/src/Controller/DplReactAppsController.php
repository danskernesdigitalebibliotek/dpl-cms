...
class DplReactAppsController extends ControllerBase {
  ...
  public function work(string $wid): array {
    $data = [
      ...
      'online-internal-success-reserved-text' => $this->t('You have reserved the material. If you have provided an phonenumber or email during the reservation, you will receive a notification when the material is ready. Please note that the loan does not happen automatically – you must manually borrow the digital material yourself within 48 hours.', [], ['context' => 'Work Page']),
