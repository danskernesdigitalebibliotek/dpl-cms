  ...
  public function search(): array {
    ...
    $build = [
      'search-result' => dpl_react_render('search-result', [
        ...
        'facet-children-or-adults-text' => $this->t('Children or adults', [], $options),
        'facet-creators-text' => $this->t('Creators', [], $options),
        'facet-fiction-nonfiction-text' => $this->t('Fiction or nonfiction', [], $options),
  ...
  public function work(string $wid): array {
    ...
    $build = [
      'material' => dpl_react_render('material', [
        ...
        'find-on-shelf-modal-list-material-text' => $this->t('Material', [], $c),
        'find-on-shelf-modal-no-location-specified-text' => $this->t('-', [], $c),
        ...
        'find-on-shelf-modal-screen-reader-modal-description-text' => $this->t('Modal for reservation', [], $c),
        ...
        'infomedia-modal-screen-reader-modal-description-text' => $this->t('Modal for infomedia', [], $c),
