  ...
  public function work(string $wid): array {
    ...
    $build = [
      'material' => dpl_react_render('material', [
        ...
        'order-digital-copy-text' => $this->t('Order digital copy', [], $c),
        'order-digital-copy-modal-screen-reader-modal-description-text' => $this->t('Order digital copy of article', [], $c),
        'order-digital-copy-modal-close-modal-aria-label-text' => $this->t('Close digital article copy modal', [], $c),
        'order-digital-copy-title-text' => $this->t('Order digital copy', [], $c),
        'order-digital-copy-description-text' => $this->t('You can order a digital copy of this material. The digital copy will be sent to your email address.', [], $c),
        'order-digital-copy-button-text' => $this->t('Order digital copy', [], $c),
        'order-digital-copy-button-loading-text' => $this->t('Ordering digital copy', [], $c),
