...
class DplReactAppsController extends ControllerBase {
  ...
  public function work(string $wid): array {
    $data = [
      ...
      'order-digital-copy-feedback-error-agency-not-subscribed-text' => $this->t('The agency is not subscribed to the service. You can order the digital copy by contacting the agency.', [], ['context' => 'Work Page']),
      'order-digital-copy-feedback-error-invalid-pickup-branch-text' => $this->t('The pickup branch is not valid. You can order the digital copy by contacting the agency.', [], ['context' => 'Work Page']),
      'order-digital-copy-feedback-error-missing-client-configuration-text' => $this->t('The client configuration is missing. You can order the digital copy by contacting the agency.', [], ['context' => 'Work Page']),
      ...
      'order-digital-copy-feedback-error-pid-not-reservable-text' => $this->t('The material is not reservable. You can order the digital copy by contacting the agency.', [], ['context' => 'Work Page']),
      'order-digital-copy-feedback-error-unauthenticated-user-text' => $this->t('You are not logged in. You can order the digital copy by contacting the agency.', [], ['context' => 'Work Page']),
