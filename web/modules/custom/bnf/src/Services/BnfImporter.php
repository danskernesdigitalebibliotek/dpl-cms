...
class BnfImporter {
   ...
   */
  public function importNode(string $uuid, string $endpointUrl, string $nodeType = 'article', bool $keepUpdated = TRUE): NodeInterface {
    ...
    try {
      ...
      $node->set('bnf_keep_updated', $keepUpdated);
