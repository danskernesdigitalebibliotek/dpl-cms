...
class BnfImporter {
   ...
   */
  public function importNode(string $uuid, string $endpointUrl, string $nodeType = 'article', bool $clientSource = FALSE): NodeInterface {
    ...
    try {
      ...
      if ($clientSource && $node->get('field_canonical_url')->isEmpty() && $info) {
