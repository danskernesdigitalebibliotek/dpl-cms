 ...
 */
class PatronGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatronGroup';
    ...
    protected static $openAPITypes = [
        'child_groups' => '\DanskernesDigitaleBibliotek\FBS\Model\PatronGroup[]',
        'description' => 'string',
        'members_count' => 'int',
        'name' => 'string',
        'patron_group_id' => 'int'
    ...
    {
        $this->container['child_groups'] = $data['child_groups'] ?? null;
     ...
     * Gets child_groups
     *
     * @return \DanskernesDigitaleBibliotek\FBS\Model\PatronGroup[]|null
     */
     ...
     * Sets child_groups
     *
     * @param \DanskernesDigitaleBibliotek\FBS\Model\PatronGroup[]|null $child_groups The array of child groups of this group
     *
     * @return self
     */
     ...
     * Sets members_count
     *
     * @param int $members_count The number of all members in this group, including descendants
     *
     * @return self
     */
     ...
     *
     * @param int $patron_group_id The patron group identifier
     *
     * @return self
     */
