...
/**
 * AvailabilityV3 Class Doc Comment
 *
 * @category Class
 * @package  DanskernesDigitaleBibliotek\FBS
 * @author   OpenAPI Generator team
 ...
 */
class AvailabilityV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailabilityV3';
     ...
     * Sets available
     *
     * @param bool $available True if materials is available on-shelf at some placement, false if all materials are lent out
     *
     * @return self
     */
     ...
     * Sets reservable
     *
     * @param bool $reservable True if materials can be reserved
     *
     * @return self
     */
     ...
     * Sets reservations
     *
     * @param int $reservations Total number of current active reservations of the Bibliographic record
     *
     * @return self
     */
