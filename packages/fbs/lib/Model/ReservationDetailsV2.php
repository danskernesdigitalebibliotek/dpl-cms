...
/**
 * ReservationDetailsV2 Class Doc Comment
 *
 * @category Class
 * @package  DanskernesDigitaleBibliotek\FBS
 * @author   OpenAPI Generator team
 ...
 */
class ReservationDetailsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReservationDetailsV2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reservation_type'] = $data['reservation_type'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reservation_type'] === null) {
            $invalidProperties[] = "'reservation_type' can't be null";
        }
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id Identifies the transaction of reservations
     *
     * @return self
     */
