...
/**
 * AgencyDepartment Class Doc Comment
 *
 * @category Class
 * @package  DanskernesDigitaleBibliotek\FBS
 * @author   OpenAPI Generator team
 ...
 */
class AgencyDepartment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgencyDepartment';
     ...
     * Sets department_id
     *
     * @param string $department_id Department identifier
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Name of the department
     *
     * @return self
     */
