...
/**
 * FeeMaterialV2 Class Doc Comment
 *
 * @category Class
 * @package  DanskernesDigitaleBibliotek\FBS
 * @author   OpenAPI Generator team
 ...
 */
class FeeMaterialV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeeMaterialV2';
     ...
     *
     * @param string $material_item_number Identifies the exact material covered by the fee
     *
     * @return self
     */
