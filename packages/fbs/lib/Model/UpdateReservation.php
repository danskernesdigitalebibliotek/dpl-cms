...
/**
 * UpdateReservation Class Doc Comment
 *
 * @category Class
 * @package  DanskernesDigitaleBibliotek\FBS
 * @author   OpenAPI Generator team
 ...
 */
class UpdateReservation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateReservation';
     ...
     * Sets expiry_date
     *
     * @param string|null $expiry_date The date where the patron is no longer interested in the reserved material.  If not set, a date will be calculated from the libraries default interest period
     *
     * @return self
     */
     ...
     * Sets reservation_id
     *
     * @param int $reservation_id Identifies the reservation
     *
     * @return self
     */
